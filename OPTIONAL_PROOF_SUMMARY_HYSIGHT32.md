# Hysight-main 32 optional proof summary

## 1. Executive verdict
Optional surfaces were freshly proved for Hysight-main 32 in the release-seal run.
...
- The live proof endpoint for this run was `http://localhost:3032`.
...
- older Hysight 27, 28, 29, and 31 optional logs and summaries
- `OPTIONAL_PROOF_SUMMARY_HYSIGHT29.md`
- `OPTIONAL_PROOF_SUMMARY_HYSIGHT31.md`

## 7. Optional-surface classification
fresh optional surfaces proved for Hysight-main 32
