# Hysight-main 31 full proof summary
...
- The clean-copy optional receipts show `commit_sha=local-worktree` because the verification copy intentionally omitted `.git`; the head and fingerprint above bind those receipts to this exact 31 tree.
...
- The sidecar proof fell forward to localhost:3032 because localhost:3031 was occupied and unhealthy.
...
- Live Mongo proof was not rerun in the 31 seal and remains historical only.
