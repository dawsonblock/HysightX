...
- How frontend proof is bootstrapped: `make test-bootstrap-frontend` installs the pinned Yarn dependencies under Node 24 / Yarn 1.22.22, and `make proof-frontend` runs the canonical frontend proof wrapper
